...
### Glycolysis
"Sugar-splitting".
- Takes one glucose (6 carbons) and turns it into two pyruvate (3+3 carbons)
- Happens in *cytosol* (doesn't need oxygen/mitochondria)

All **glycolysis** go through [[Introduction to Metabolism#Catabolism]].
**Fat** and **glycogen** is being stored through the reaction of [[Introduction to Metabolism#Anabolism]]
