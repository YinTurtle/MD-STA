...
- Can be classified to:
	- Somatic reflexes - somatic motor neurones and skeletal muscles
		- Control muscle contraction
			- e.g. removing hand form hot object
				sensory receptor detects heat, sends signals to neurons, then motor neurones synapses the muscle to contract (spinal reflex)
			- e.g. lift foot off sharp object (spinal reflex)
...
- Sometimes aware of stimulus and/or response (such as able to look at self shivering, or skin hair standing up)
- For many reflexes, no conscious awareness of doing such reflex

Examples of such homeostasis happening can occur not only for temperature, but also blood pressure etc.

### Pathway Mediating a Reflex Arc
![[Pasted image 20260216121712.png|700]]
...
![[Pasted image 20260216122143.png]]
Myelinated fibres conduct nerve impulses significantly faster than unmyelinated fibres because myelin sheath acts as an electrical insulator, forcing the signal to jump between gaps in the sheath rather than traveling continuously along the entire membrane.

### Organisation of the Spinal Cord
- From the afferent sensory, it goes to the Lamina I-VI (dorsal horn)
- Then VII (lateral horn)
- Then VIII and IX (ventral horn)
![[Pasted image 20260216122531.png]]
**Order to spinal cord** 
1. Lamina I-VI (dorsal horn)
	1. terminations for primary afferent sensory neurons & neurons of reflex circuits
	2. Sensory input from joints and muscle (lamina VI)
2. Lamina VII (lateral horn)
	1. Preganglionic sympathetic (T1-L2) & parasympathetic (sacral)
3. Lamina VIII & IX (ventral horn)
	1. Cell bodies of motor neurons
...
- Some axons branch back into cord and synapse with interneurons called **Renshaw cells** (recurrent or feedback inhibition)
	- Renshaw cells help provide smooth movements
	- Supresses weakly firing motor neurons and dampening strongly firing ones
	- Produces economical movement
- **Strychnine poisoning**
	- Disables Renshaw cell inhibition - leads to convulsions
	- This leads to very "jerky" contractions
![[Pasted image 20260216123402.png]]

### Myotatic (Knee Jerk) Reflex
- Good to test whether is it a upper or lower motor neurone issue
	- If exaggerated (hyperreflexia) - loss of inhibitory control from upper motor neurons (brain or spinal cord)
	- If reflex is weak or absent - loss or damage of lower motor neuron (nerve roots or peripheral nerves)
- Example of **monosynaptic** stretch reflex
![[Pasted image 20260216123835.png]]
- Reflex stimulates in the spinal cord - the motor neurons to the extensor muscle
	- While at the same time inhibits the antagonistic flexor muscle
...
#### Muscle Spindles
- Are sensory receptors within skeletal muscles that detect changes in muscle length and velocity
- Serve as proprioceptors for central nervous system
	- Trigger stretch reflex - rapid, involuntary contraction of muscle to resist overstretching
- Lie parallel with skeletal muscle fibres
- Innervated by gamma-motoneurons (efferents) and group 1a and 11 afferent fibres
##### Voluntary Activity
...
![[Pasted image 20260216124441.png]]
...
- Stimulation of GTO receptor, sends signal to sensory, and sends to inhibitory interneuron
	- Inhibitory interneuron will stops the muscle from damaging itself
...
- Inhibitory effect from GTO can be so great that it leads to sudden unloading of muscles
![[Pasted image 20260216124742.png]]
- Allows the proper up right posture
- Basically the reflex inhibits the agonist muscle and excites the antagonist
...
![[Pasted image 20260216124954.png]]
![[Pasted image 20260216125001.png]]

### Withdrawal Reflex and Crossed Extensor
...
![[Pasted image 20260216125131.png]]
...
![[Pasted image 20260216125345.png]]
- All of these generated within the spinal cord
...
![[Pasted image 20260216125644.png]]