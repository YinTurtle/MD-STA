...
- To understand how antibody diversity is generated.
- To describe the generation and uses of monoclonal antibodies.
- To understand antibody function and antibody/antigen immune complexes.
...
![[Pasted image 20260219151315.png]]
...
![[Pasted image 20260219151430.png]]

Lymph nodes swell because B cells are proliferating during an immune response, which produces antibodies.
...
![[Pasted image 20260219151612.png]]

### Spleen
- Red pulp is site of RBC destruction. White pulp is lymphoid.
- Blood carrying lymphocytes and antigen enter from a trabecular artery into a central arteriole. 
- They can then pass into a marginal sinus and exit through a trabecular vein.
...
- **Important** - antigen enters from blood rather than lymph

### Course of antibody production
![[Pasted image 20260219151901.png]]
- Memory B cells are being stored for future response
- B cells form part of the adaptive immune response, the key features of which are antigen specificity, and memory.
- Three key points:
	- the secondary (memory) response is faster, 
	- can produce more antibody
	- does not prevent you from making a response to another antigen (multiple antigens -vaccination)

### Basic features of antibodies (Ab)
...
- Two L chain exist, lambda (!) and kappa ("). Any individual Ab has either ! or ", never a mixture of each. In human the ratio is 2:1 in favour of ".

### Antibody structure
2 identical H and L chains results in two identical binding sites.
![[Pasted image 20260219152212.png]]

![[Pasted image 20260219152315.png]]

### Extra variability by Junctional Diversity
- N-nucleotides, (non template-encoded) are added by terminal deoxynulceotidyl transferase (TdT)
- After up to 20 nucleotides are added, pairing is attempted, followed by trimming off nonmatching bases, filling gaps and ligation to complete (all is random).
![[Pasted image 20260219152952.png]]
...
![[Pasted image 20260219153144.png]]

### Classes if Ab (5)
Defined by heaving chain
![[Pasted image 20260219153248.png]]

![[Pasted image 20260219153314.png]]

### Antibody  multimers
- IgM can be secreted as pentamers, IgA as dimers. Both involve an additional J chain in this process
#### IgA secretion
![[Pasted image 20260219153552.png]]

#### Distribution of Ab isotypes
Distribution of AG isotypes in body.
...
- IgE is found mostly near to epithelial
- Surfaces, especially gut, lungs and skin. The brain is normally free from Ab
![[Pasted image 20260219153719.png]]

### Ab function - Blocking
![[Pasted image 20260219153744.png]]

#### Promoting antigen phagocytosis
![[Pasted image 20260219153900.png]]
Mast cell degranulation - allergy

### Antibody-dependent cell-mediated cytotoxicity (ADCC)
![[Pasted image 20260219154020.png]]
Antibody-antigen complexes. An important mechanism for clearing soluble antigens. Taken up by phagocytes. Note, importantly, that high levels of Ab-Ag complexes are prevalent in some autoimmune disease, major cause of glomerulonephritis

![[Pasted image 20260219154039.png]]

### Monoclonal Antibodies
(mAbs)
Laboratory-produced, identical copies of specific immune system proteins designed to bind to, detect, or destroy specific antigens, such as cancer cells, pathogens, or hormones.
![[Pasted image 20260219154222.png]]

### Clinical/lab biologicals (optional)
